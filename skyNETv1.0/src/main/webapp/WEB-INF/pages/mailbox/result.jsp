          ...
          <div class="box box-success">
            ...
            <div class="box-body">
					<form:form commandName="checkcheck">
						...
						<img src="${pageContext.request.contextPath}/resources/img/mailOK.png"/>
						<br><br>
						<a href="${pageContext.request.contextPath}/member/list"> 주소록 이동 </a>
						</c:if>
						<c:if test="${result eq 'fail'}" >
						<img src="${pageContext.request.contextPath}/resources/img/mailFail.png" width="200px"/>
						<br><br><br>
						<p> 발송에 실패했습니다. 구글 계정을 다시 확인 해주세요 </p>
						<br><br>
						<a href="${pageContext.request.contextPath}/member/list"> 다시시도 </a>
						</c:if>
