      ...
      <div class="row">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <ul class="todo-list">
				<c:forEach var="notice" begin="1" step="1" end="5" items="${notice}">
                <li>
                  <!-- todo text -->
                  <!-- Emphasis label -->
                  <small class="label label-default">[${notice.notice_type}]</small>
                  <span class="text">${notice.notice_title}</span>
...
<!--               <button type="button" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Add item</button> -->
          ...
          <div class="box box-warning">
            <div class="box-header">
              ...
              <h3 class="box-title">Group Member</h3>

              <div class="box-tools pull-right">
                <button type="button" class="btn btn-warning btn-xs" data-widget="collapse"><i class="fa fa-minus"></i>
                </button>
                <button type="button" class="btn btn-warning btn-xs" data-widget="remove"><i class="fa fa-times"></i>
                </button>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
				...
				<c:forEach var="member" items="${member}">
                  ...
                  <!-- Emphasis label -->
                  	<tr>
                  		<td><span class="text"><a href="${pageContext.request.contextPath}/member/detail/${member.member_enum}">${member.member_name}</a></span></td>
                  		<td><span class="text">${member.member_phone}</span></td>
                  		<td><span class="text">${member.member_enum}</span></td>
                  		<td><span class="text">${member.rank_name}</span></td>
                  		<td><span class="text">${member.member_email}</span></td>
                  	</tr>
