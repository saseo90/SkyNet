...
//				String fileName = file.getName();
		...
		List<LoginVo> memberList =service.getUser();
	...
	public String stateReport(HttpServletRequest request){
		...
		try {
			list=service.select((LoginVo) SessionUtil.getAttribute("login"));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public String waitReport(HttpServletRequest request){
		...
		List<ReportVo> list = null;
		try {
			list=service.check((LoginVo) SessionUtil.getAttribute("login"));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
